        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              ...
              >
                <h2 class="phone">{{ item.receiverName }}</h2>
...
export default {
  ...
  data() {
    return {
      ...
      showEditModal: false, //是否显示新增或者编
      checkIndex: 0, //当前收货地址选中索引(默认是第一个)
    };
  },
  mounted() {
    this.getAddressList();
  ...
  methods: {
    ...
    openAddressModal() {
      (this.ediTitle = "新增确认"), (this.userAction = 0);
      this.checkedItem = {};
      this.showEditModal = true;
    },
    editAddressModal(item) {
      (this.ediTitle = "编辑地址"), (this.userAction = 1);
    ...
    submitAddress() {
      ...
      this.axios[method](url, params).then(() => {
        this.closeModal();
        this.getAddressList(); //拉取一次地址，公用一个账号，也可以即使更新数据
